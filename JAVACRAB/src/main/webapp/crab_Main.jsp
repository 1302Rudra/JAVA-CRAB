        ...
        <section id="People">
          <div class="container">
            <div class="people">
              ...
              <h3 style="color: #ff6600; font-size: 24px;">Rudra Patel</h3>
              ...
              <a href="https://github.com/1302Rudra/JAVA-CRAB/tree/main" target="_blank"><img src="github.png" alt="GitHub" style="width: 20px; height: 20px; margin-top: 10px;"></a>
            </div>
            <div class="people">
              ...
              <a href="https://github.com/TuxDev12/Profile" target="_blank"><img src="github.png" alt="GitHub" style="width: 20px; height: 20px; margin-top: 10px;"></a>
            </div>
          </div>
        </section>
      </main>
